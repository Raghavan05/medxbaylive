...
const CreateNewAccount = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_BASE_URL}/admin/create-account`, formData, { withCredentials: true });
            ...
            <ToastContainer />
                    ...
                    <div className="CreateNewAccount-form-sub-container">
                        <div className="CreateNewAccount-form-input-header">
                           ...
                           <p className="CreateNewAccount-form-input-placeholder">
                                {formData.role === "corporate" ? "Corporate Name" : "Name"}
                ...
                <div className="CreateNewAccount-button-group">
                    ...
                    <button
                        ...
                        onClick={() => {
                            navigate('/admin/dashboardpage/admin-manage-accounts');
                        }}
                    >
                        Back to Accounts
                    </button>
